...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x7f86ae7dc020, const void *arg_0x7f86ae7dc320);
#line 780
__extension__ 
#line 797
__extension__ 
...
#line 250
extern double erfc(double arg_0x7f86ae7545e0) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 326
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x7f86ae4f73a0), 
int (*key_eq_fn)(void *arg_0x7f86ae4f7b70, void *arg_0x7f86ae4f7e30));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x7f86ae2e4c00, int arg_0x7f86ae2e4e80);
static double RandomUniform(void );
...
typedef uint16_t Node__packList__t;
...
typedef uint16_t /*NodeC.NeighborListC*/ListC__0__t;
typedef /*NodeC.NeighborListC*/ListC__0__t /*NodeC.NeighborListC*/ListC__0__List__t;
typedef uint16_t /*NodeC.packListC*/ListC__1__t;
typedef /*NodeC.packListC*/ListC__1__t /*NodeC.packListC*/ListC__1__List__t;
...
static uint16_t /*NodeC.packListC*/ListC__1__List__size(void );
static /*NodeC.packListC*/ListC__1__List__t /*NodeC.packListC*/ListC__1__List__get(uint16_t position);
#line 17
static void /*NodeC.packListC*/ListC__1__List__pushback(/*NodeC.packListC*/ListC__1__List__t input);


static /*NodeC.packListC*/ListC__1__List__t /*NodeC.packListC*/ListC__1__List__popfront(void );
...
static Node__packList__t Node__packList__popfront(void );
# 64 "/opt/tinyos-main/tos/lib/timer/Timer.nc"
...
uint16_t Node__seqCounter[1000];
...
uint16_t /*NodeC.packListC*/ListC__1__MAX_SIZE[1000];

/*NodeC.packListC*/ListC__1__t /*NodeC.packListC*/ListC__1__container[1000][60];
uint16_t /*NodeC.packListC*/ListC__1__size[1000];

static void /*NodeC.packListC*/ListC__1__List__pushback(/*NodeC.packListC*/ListC__1__t input);
#line 54
static /*NodeC.packListC*/ListC__1__t /*NodeC.packListC*/ListC__1__List__popfront(void );
#line 87
static inline uint16_t /*NodeC.packListC*/ListC__1__List__size(void );



static inline /*NodeC.packListC*/ListC__1__t /*NodeC.packListC*/ListC__1__List__get(uint16_t position);
...
#line 17
  /*NodeC.packListC*/ListC__1__List__pushback(input);
#line 17
}
#line 17
...
inline static Node__packList__t Node__packList__popfront(void ){
#line 20
  unsigned short __nesc_result;
#line 20

#line 20
  __nesc_result = /*NodeC.packListC*/ListC__1__List__popfront();
#line 20
...
#line 87
{
  return /*NodeC.packListC*/ListC__1__size[sim_node()];
}
...
#line 24
  __nesc_result = /*NodeC.packListC*/ListC__1__List__size();
#line 24
...
#line 91
{
  return /*NodeC.packListC*/ListC__1__container[sim_node()][position];
}
...
#line 25
  __nesc_result = /*NodeC.packListC*/ListC__1__List__get(position);
#line 25
...
#line 56
  bool isvisited;
  uint16_t i;
  uint16_t size = Node__packList__size();
  ...
  if (len == sizeof(pack )) {
      ...
      sim_log_debug(112U, FLOODING_CHANNEL, "Node %d has seen packets from: ", TOS_NODE_ID);
      for (i = 0; i < size; i++) 
        {
          sim_log_debug(113U, FLOODING_CHANNEL, "%d, ", Node__packList__get(i));
          if (__nesc_ntoh_uint16(myMsg->seq.nxdata) == Node__packList__get(i)) 
            {
              isvisited = TRUE;
            }
        }
      sim_log_debug(114U, FLOODING_CHANNEL, "\n");




      if (__nesc_ntoh_uint8(myMsg->TTL.nxdata) > 0 && isvisited == FALSE) 
        {

          if (__nesc_ntoh_uint8(myMsg->protocol.nxdata) == PROTOCOL_PING) 
            {
              sim_log_debug(115U, NEIGHBOR_CHANNEL, "Packet received from %d at %d\n", __nesc_ntoh_uint16(myMsg->src.nxdata), TOS_NODE_ID);

              if (__nesc_ntoh_uint16(myMsg->dest.nxdata) == TOS_NODE_ID) 
                {
                  sim_log_debug(116U, NEIGHBOR_CHANNEL, "Packet received at intended location %d ==%d from %d\n", __nesc_ntoh_uint16(myMsg->dest.nxdata), TOS_NODE_ID, __nesc_ntoh_uint16(myMsg->src.nxdata));
                  Node__makePack(&Node__sendPackage[sim_node()], TOS_NODE_ID, AM_BROADCAST_ADDR, __nesc_ntoh_uint8(myMsg->TTL.nxdata) - 1, PROTOCOL_PINGREPLY, __nesc_ntoh_uint16(myMsg->seq.nxdata), (uint8_t *)myMsg->payload, sizeof  myMsg->payload);
                  Node__Sender__send(Node__sendPackage[sim_node()], __nesc_ntoh_uint16(myMsg->src.nxdata));
                  if (Node__packList__size() == 60) 
                    {
                      uint16_t temp = Node__packList__popfront();

                    }
#line 99
                  Node__packList__pushback(__nesc_ntoh_uint16(myMsg->seq.nxdata));
                }
              else {
                ...
                if (__nesc_ntoh_uint16(myMsg->dest.nxdata) == AM_BROADCAST_ADDR) 
                  ...
                  {
                    sim_log_debug(117U, NEIGHBOR_CHANNEL, "Packet not intended for location %d from %d\n", TOS_NODE_ID, __nesc_ntoh_uint16(myMsg->src.nxdata));
                    Node__makePack(&Node__sendPackage[sim_node()], TOS_NODE_ID, __nesc_ntoh_uint16(myMsg->dest.nxdata), __nesc_ntoh_uint8(myMsg->TTL.nxdata) - 1, __nesc_ntoh_uint8(myMsg->protocol.nxdata), __nesc_ntoh_uint16(myMsg->seq.nxdata), (uint8_t *)myMsg->payload, sizeof  myMsg->payload);
...
#line 120
            if (__nesc_ntoh_uint8(myMsg->protocol.nxdata) == PROTOCOL_PINGREPLY) 
              {
                sim_log_debug(118U, NEIGHBOR_CHANNEL, "Ping reply received from %d\n", __nesc_ntoh_uint16(myMsg->src.nxdata));
...
#line 130
...

        {
          ...
          sim_log_debug(119U, FLOODING_CHANNEL, "TTL for Packet is %d\n", __nesc_ntoh_uint8(myMsg->TTL.nxdata));
          if (isvisited == TRUE) 
            {
              sim_log_debug(120U, FLOODING_CHANNEL, "Node %d has seen the packet\n", TOS_NODE_ID);
            }
        }
  ...
  sim_log_debug(121U, GENERAL_CHANNEL, "Unknown Packet Type %d\n", len);
  return msg;
}
...
# 78 "/opt/tinyos-main/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Receive__receive(am_id_t arg_0x7f86adfd5e30, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x7f86adfd5e30) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC__Receive__default__receive(arg_0x7f86adfd5e30, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-main/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Snoop__receive(am_id_t arg_0x7f86adfd4a50, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC__Snoop__default__receive(arg_0x7f86adfd4a50, msg, payload, len);
#line 78
...
{
  if (err == SUCCESS) {
      Node__periodicTimer__startPeriodic(3000);
      sim_log_debug(109U, GENERAL_CHANNEL, "Radio is On\n");
    }
  else 
#line 47
    {
...
# 110 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC__AMSend__sendDone(am_id_t arg_0x7f86adfefc70, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x7f86adfefc70, msg, error);
#line 110
}
#line 110
...
#line 88
# 80 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x7f86ad956b60, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC__AMSend__send(arg_0x7f86ad956b60, addr, msg, len);
#line 80
...
# 100 "/opt/tinyos-main/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x7f86ad957940, message_t * msg, error_t error){
#line 100
  switch (arg_0x7f86ad957940) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x7f86ad957940, msg, error);
#line 100
      break;
#line 100
    }
...
#line 157
{
  sim_log_debug(122U, GENERAL_CHANNEL, "PING EVENT \n");
  Node__seqCounter[sim_node()]++;
  Node__makePack(&Node__sendPackage[sim_node()], TOS_NODE_ID, destination, MAX_TTL, PROTOCOL_PING, Node__seqCounter[sim_node()], payload, PACKET_MAX_PAYLOAD_SIZE);
  if (Node__packList__size() == 60) 
    {
      uint16_t temp = Node__packList__popfront();
...
#line 165
  Node__packList__pushback(Node__seqCounter[sim_node()]);
  Node__Sender__send(Node__sendPackage[sim_node()], AM_BROADCAST_ADDR);
}
...
# 75 "/opt/tinyos-main/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x7f86ae1b8020){
#line 75
  switch (arg_0x7f86ae1b8020) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP__TaskBasic__default__runTask(arg_0x7f86ae1b8020);
#line 75
      break;
#line 75
    }
...
# 83 "/opt/tinyos-main/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x7f86ada08950){
#line 83
  switch (arg_0x7f86ada08950) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x7f86ada08950);
#line 83
      break;
#line 83
    }
...
#line 54
{
  /*NodeC.packListC*/ListC__1__t returnVal;
  uint16_t i;

  returnVal = /*NodeC.packListC*/ListC__1__container[sim_node()][0];
  if (/*NodeC.packListC*/ListC__1__size[sim_node()] > 0) {

      for (i = 0; i < /*NodeC.packListC*/ListC__1__size[sim_node()] - 1; i++) {
          /*NodeC.packListC*/ListC__1__container[sim_node()][i] = /*NodeC.packListC*/ListC__1__container[sim_node()][i + 1];
        }
      /*NodeC.packListC*/ListC__1__size[sim_node()]--;
    }
...
#line 21
{
  ...
  if (/*NodeC.packListC*/ListC__1__size[sim_node()] < /*NodeC.packListC*/ListC__1__MAX_SIZE[sim_node()]) {

      /*NodeC.packListC*/ListC__1__container[sim_node()][/*NodeC.packListC*/ListC__1__size[sim_node()]] = input;
      /*NodeC.packListC*/ListC__1__size[sim_node()]++;
    }
}
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "Node__seqCounter"))
  {
    *addr = (uintptr_t)&Node__seqCounter[__nesc_mote];
    *size = sizeof(Node__seqCounter[__nesc_mote]);
    return 0;
  }
  ...
  /* Module ListC__1 */
  if (!strcmp(varname, "/*NodeC.packListC*/ListC__1__MAX_SIZE"))
  {
    *addr = (uintptr_t)&/*NodeC.packListC*/ListC__1__MAX_SIZE[__nesc_mote];
    *size = sizeof(/*NodeC.packListC*/ListC__1__MAX_SIZE[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*NodeC.packListC*/ListC__1__container"))
  {
    *addr = (uintptr_t)&/*NodeC.packListC*/ListC__1__container[__nesc_mote];
    *size = sizeof(/*NodeC.packListC*/ListC__1__container[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*NodeC.packListC*/ListC__1__size"))
  {
    *addr = (uintptr_t)&/*NodeC.packListC*/ListC__1__size[__nesc_mote];
    *size = sizeof(/*NodeC.packListC*/ListC__1__size[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  Node__seqCounter[__nesc_mote] = 0;
  ...
  /* Module ListC__1 */
  /*NodeC.packListC*/ListC__1__MAX_SIZE[__nesc_mote] = 60;
  memset((void *)&/*NodeC.packListC*/ListC__1__container[__nesc_mote], 0, sizeof /*NodeC.packListC*/ListC__1__container[__nesc_mote]);
  /*NodeC.packListC*/ListC__1__size[__nesc_mote] = 0;
